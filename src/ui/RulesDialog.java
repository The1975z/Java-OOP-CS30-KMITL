...
public class RulesDialog extends JDialog {
    ...
    public RulesDialog(StartScreen parent, Color goldAccent, Color textColor, Font copyrightFont, 
        ...
        mainPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                String copyright = "© 2023-2025 Clamp War. All Rights Reserved. KMITL Computer Science.";
        ...
        JLabel titleLabel = new JLabel("Clamp War GAME RULES", SwingConstants.CENTER);
    ...
    private void addRuleSection(JPanel panel, String sectionText) {
        ...
        if (title.contains("CAPTURING") || title.contains("ATARI")) {
            ...
            // เพิ่มโค้ด 3 บรรทัดนี้หลังจากสร้าง panels
            Dimension smallSize = new Dimension(85, 85); // ขนาดเล็กลงจาก 100x100
            verticalPanel.setPreferredSize(smallSize);
            surroundPanel.setPreferredSize(smallSize);
            chainPanel.setPreferredSize(smallSize);
            cornerPanel.setPreferredSize(smallSize);

            JPanel capturesPanel = new JPanel();
            capturesPanel.setLayout(new GridLayout(2, 2, 10, 10));
            capturesPanel.setOpaque(false);
            
            // เพิ่มโค้ด 2 บรรทัดนี้ก่อนเพิ่ม panels
            capturesPanel.setPreferredSize(new Dimension(200, 200)); // ขนาดรวมเล็กลง
            capturesPanel.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 15)); // เพิ่มระยะห่างจากขอบ
    ...
    public static String createDetailedRules() {
        StringBuilder sb = new StringBuilder();

        sb.append("INTRODUCTION TO Clamp War GAME\n");
        sb.append("Clamp War is a strategic board game combining elements of Go and Checkers. Players must think several moves ahead while trying to capture opponent's pieces and protect their own. The game offers a perfect balance of strategy, tactics, and planning.\n\n");
