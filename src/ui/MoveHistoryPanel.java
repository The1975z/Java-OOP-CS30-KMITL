...
public class MoveHistoryPanel extends JPanel {
    ...
    private JPanel createMoveRow(MoveRecord move) {
        ...
        // 4. คอลัมน์ที่สี่: เวลาที่ใช้โดยฝ่ายขาว (W Time Used) - แสดงเฉพาะเมื่อมีการเดินของฝ่ายขาว
        String whiteTimeDisplay = isWhiteMove ? formatTimeDisplay(move.whiteTimeTaken) : "-";
        ...
        // 5. คอลัมน์ที่ห้า: เวลาที่ใช้โดยฝ่ายดำ (B Time Used) - แสดงเฉพาะเมื่อมีการเดินของฝ่ายดำ
        String blackTimeDisplay = isBlackMove ? formatTimeDisplay(move.blackTimeTaken) : "-";
