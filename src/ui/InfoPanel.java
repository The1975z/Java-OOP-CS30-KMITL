...
public class InfoPanel extends JPanel {
    ...
    public InfoPanel(GameController controller) {
        ...
        whiteRemainingLabel.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createLineBorder(
                        new Color(GOLD_ACCENT.getRed(), GOLD_ACCENT.getGreen(), GOLD_ACCENT.getBlue(), 100), 1),
        ...
        whiteCapturedLabel.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createLineBorder(new Color(255, 100, 100, 100), 1),
                BorderFactory.createEmptyBorder(3, 8, 3, 8)));
        ...
        blackRemainingLabel.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createLineBorder(
                        new Color(GOLD_ACCENT.getRed(), GOLD_ACCENT.getGreen(), GOLD_ACCENT.getBlue(), 100), 1),
                BorderFactory.createEmptyBorder(3, 8, 3, 8)));
        ...
        blackCapturedLabel.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createLineBorder(new Color(255, 100, 100, 100), 1),
                BorderFactory.createEmptyBorder(3, 8, 3, 8)));
    ...
    public void updatePieceCount(int whiteRemaining, int blackRemaining, int whiteCaptured, int blackCaptured) {
        System.out.println("InfoPanel: Updating piece count - White: " + whiteRemaining +
                "/" + blackCaptured + ", Black: " + blackRemaining +
                "/" + whiteCaptured);
